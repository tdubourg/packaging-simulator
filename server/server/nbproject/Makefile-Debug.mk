...
${OBJECTDIR}/_ext/1738881925/partsPackager.o: ../../../../../../Dropbox/Documents/TP-IF/4IF/ciai/code/server/server/partsPackager.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1738881925/partsPackager.o ../../../../../../Dropbox/Documents/TP-IF/4IF/ciai/code/server/server/partsPackager.c

${OBJECTDIR}/doWarehouse.o: doWarehouse.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/doWarehouse.o doWarehouse.c

${OBJECTDIR}/doLog.o: doLog.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/doLog.o doLog.c

${OBJECTDIR}/doPrint.o: doPrint.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/doPrint.o doPrint.c

${OBJECTDIR}/doPalette.o: doPalette.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/doPalette.o doPalette.c
...
${OBJECTDIR}/doControl.o: doControl.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/doControl.o doControl.c

${OBJECTDIR}/doCommunication.o: doCommunication.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/doCommunication.o doCommunication.c
